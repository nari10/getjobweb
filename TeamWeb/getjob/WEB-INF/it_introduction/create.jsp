...
<!-- 					<li><a href="signup.job">로그인/회원가입</a></li>
 -->				</ul>
	...
	<div style="margin: 100px 0px 0px 100px">
		<label for="jobname">직무</label><input type="text" name="jobname"/><br />
		<label for="description">설명</label><textarea name="descript" id="decript" cols="80" rows="20"></textarea><br />
